                ...
                <Grid item xs={12} md={11} lg={10}>
                  ...
                  <Grid item xs={12} sm={12} md={8}>
                    <Grid
                      className={
                        this.state.show2
                          ? 'cnfrmDiaMain1 setPaymentBack'
                          : 'cnfrmDiaMain profilePkg cnfrmDiaMain1'
                      }
                    >
                      {!this.state.show2 && (
                        <Grid>
